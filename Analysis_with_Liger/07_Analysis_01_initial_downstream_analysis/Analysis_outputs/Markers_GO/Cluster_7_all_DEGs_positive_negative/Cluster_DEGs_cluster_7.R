...
cluster_degs = FindConservedMarkers(integrated.data, ident.1 = "7", grouping.var = "Genotypes", test.use = "wilcox", only.pos = FALSE)
cluster_degs$gene_ID = rownames(cluster_degs)

save(cluster_degs, file = "Cluster_7_all_degs.RData")
