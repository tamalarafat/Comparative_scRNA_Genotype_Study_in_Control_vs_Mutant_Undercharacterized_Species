...
DEG_dir = paste0(project_dir, "comparative_study_of_wt_and_mutant_genotype_Cardamine/Analysis_with_Liger/07_Analysis_01_initial_downstream_analysis/Analysis_outputs/Differentially_expressed_genes/Genotypes_and_cluster_DEtest_wilcox")
...
if (!dir.exists(str_c(storing_dir, "/", "Genotype_and_cluster_specific_markers"))){
  dir.create(str_c(storing_dir, "/", "Genotype_and_cluster_specific_markers"), showWarnings = TRUE, recursive = FALSE, mode = "0777")
}

# Create a folder to store the markers file
temp_dir = str_c(storing_dir, "/", "Genotype_and_cluster_specific_markers", "/")
